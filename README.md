...
.typed-out {
  ...
  border-radius: 1px;
  white-space: nowrap;
  animation: typing 1s steps(20, end) forwards, blinking 1.2s infinite;
  font-size: 1rem;
  width: 0;
}
@keyframes typing {
...
[![CSSBattle](https://img.shields.io/badge/-CSSBattle-262626?style=for-the-badge&logo=CSSBattle&logoColor=4F7DB3)](https://cssbattle.dev/player/rostnshka)
